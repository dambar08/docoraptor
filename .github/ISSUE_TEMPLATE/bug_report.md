...
- [ ] I have searched [existing issues](https://github.com/dambar08/docoraptor/issues?q=is:issue) and [discussions](https://github.com/dambar08/docoraptor/discussions) to ensure this is not a duplicate issue
...
- Self hosted app commit SHA (find in user menu): [enter commit sha here]
  - [ ] I have confirmed that my app's commit is the latest version of Docoraptor
...
Be as specific as possible so Docoraptor maintainers can quickly reproduce the bug you're experiencing.
